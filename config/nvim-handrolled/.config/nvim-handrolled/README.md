...
This is the legacy handmade Neovim profile kept for reference and
fallback use.
...
```bash
# clone into the normal XDG location for this profile
git clone https://example.com/your/repo ~/.config/nvim-handrolled
